...
//Threshold based active-aero control with aero vectoring, designed to drive two control surfaces with 4 servos. 
...
//VECTOR LEFT  
if (accX>5000){                 // ****** Change this value to alter X threshold + value must be posative (left turn)***** higher value = less sensitive, try incriments of 2000...
    myservo1.write(pos1+100);    
    myservo2.write(pos2+100);    // servo movement in degrees
delay(800);
   myservo1.write(pos1-100);
   myservo2.write(pos2-100);
  }
...
//VECTOR RIGHT       
 if (accX<-5000){               // ****** Change this value to alter X threshold - value must be negative (right turn)*****  higher value = less sensitive, try incriments of 2000...
    myservo3.write(pos3+100);
    myservo4.write(pos4+100);   // servo movement in degrees
delay(800);
   myservo3.write(pos3-100);
   myservo4.write(pos4-100);
  }

//ACCELERATION DOWNFORCE      
 if (accY>7000||accY<-7000 &&accX<4500 &&accX>-4500){                 // ****** Change these values to alter Y threshold {first two values, higher value = less sensitive} (acceleration and aerobrake)*****
    myservo1.write(pos1+100);    
    myservo2.write(pos2+100);    
    myservo3.write(pos3+100);
    myservo4.write(pos4+100);    // servo movement in degrees
