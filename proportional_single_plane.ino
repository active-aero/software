// (c) Chris Phillips 2020 
//Proportional based active-aero control single plane, designed to drive one control surfaces with up to 4 servos. 
...
if (accYA >100) {
  ...
  myservo1.write(accYA);
  myservo2.write(accYA);
...
if (accYB >100) {
  ...
  myservo1.write(accYB);
  myservo2.write(accYB);
